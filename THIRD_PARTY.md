...
offers. The eligibility record is [docs/quality/foss-component-register.md](docs/quality/foss-component-register.md).

| Component | Version contract | Official configuration | License |
|---|---:|---|---|
| Qt | 6.11.2 | Dynamically linked LGPL modules only | LGPL-3.0-only |
...
| ggml-base.bin | `base`, 147,951,465 bytes, SHA-1 `465707469ff3a37a2b9b8d8f89f2f99de7299dac` | Downloaded on demand through an injected fetch boundary; verified before atomic install. OpenAI Whisper weights (MIT) converted to ggml; not bundled until official packaging includes MIT notices. | MIT |
