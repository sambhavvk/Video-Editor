...
The desktop module is a Qt 6 Widgets presentation layer. It carries view data and emits user intent;
the application controller owns conversion to exact edit-model commands.
