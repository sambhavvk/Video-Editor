...
signals:
  ...
  void multicamProposeTimecodeSyncRequested();
  void multicamProposeWaveformSyncRequested();
...
private:
  ...
  QPushButton* multicam_timecode_sync_{nullptr};
  QPushButton* multicam_waveform_sync_{nullptr};
