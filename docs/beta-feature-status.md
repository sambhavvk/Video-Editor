...
| CPU video preview | Implemented | Persistent FFmpeg sessions, keyframe seek, request epochs, immutable snapshot rendering, original/proxy selection with `.vepts`-mapped proxy seek, CPU Rec.709 approximation. |
